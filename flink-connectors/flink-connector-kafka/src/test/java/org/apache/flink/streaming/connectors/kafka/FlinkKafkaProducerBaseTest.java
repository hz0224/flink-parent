...
public class FlinkKafkaProducerBaseTest {
    ...
    public void testKeyValueDeserializersSetIfMissing() throws Exception {
        ...
        assertTrue(props.getProperty(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG)
    ...
    public void testPartitionerInvokedWithDeterminatePartitionList() throws Exception {
        ...
        final DummyFlinkKafkaProducer<String> producer = new DummyFlinkKafkaProducer<>(FakeStandardProducerConfig.get(),
                new KeyedSerializationSchemaWrapper<>(new SimpleStringSchema()), mockPartitioner);
        ...
        verify(mockPartitioner, times(1))
                .partition("foobar", null, "foobar".getBytes(), DummyFlinkKafkaProducer.DUMMY_TOPIC,
                        new int[]{0, 1, 2, 3});
    }
    ...
    public void testAsyncErrorRethrownOnCheckpointAfterFlush() throws Throwable {
        ...
        final OneInputStreamOperatorTestHarness<String, Object> testHarness = new OneInputStreamOperatorTestHarness<>(
                new StreamSink<>(producer));
        ...
        producer.getPendingCallbacks().get(1)
    ...
    private static class DummyFlinkKafkaProducer<T> extends FlinkKafkaProducerBase<T> {
        ...
        @SuppressWarnings("unchecked")
        DummyFlinkKafkaProducer(Properties producerConfig, KeyedSerializationSchema<T> schema,
