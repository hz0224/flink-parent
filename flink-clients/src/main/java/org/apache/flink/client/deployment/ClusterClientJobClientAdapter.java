...
public class ClusterClientJobClientAdapter<ClusterID> implements JobClient, CoordinationRequestGateway {
    ...
    public CompletableFuture<Void> cancel() {
        return bridgeClientRequest(clusterClientProvider, (clusterClient -> clusterClient.cancel(jobID).thenApply((ignored) -> null)));
    }
    ...
    public CompletableFuture<String> triggerSavepoint(@Nullable String savepointDirectory) {
        return bridgeClientRequest(clusterClientProvider, (clusterClient -> clusterClient.triggerSavepoint(jobID, savepointDirectory)));
    }
    ...
    public CompletableFuture<Map<String, Object>> getAccumulators() {
        ...
        return bridgeClientRequest(clusterClientProvider, (clusterClient -> clusterClient.getAccumulators(jobID, classLoader)));
    }
    ...
    public CompletableFuture<JobExecutionResult> getJobExecutionResult() {
         ...
         *  注释：
         */
        return bridgeClientRequest(clusterClientProvider, (clusterClient -> clusterClient.requestJobResult(jobID).thenApply((jobResult) -> {
            try {
    ...
    public CompletableFuture<CoordinationResponse> sendCoordinationRequest(OperatorID operatorId, CoordinationRequest request) {
        return bridgeClientRequest(clusterClientProvider, clusterClient -> clusterClient.sendCoordinationRequest(jobID, operatorId, request));
    }
