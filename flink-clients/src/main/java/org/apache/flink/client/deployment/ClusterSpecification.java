...
public final class ClusterSpecification {
    ...
    public String toString() {
        return "ClusterSpecification{" + "masterMemoryMB=" + masterMemoryMB + ", taskManagerMemoryMB=" + taskManagerMemoryMB + ", slotsPerTaskManager=" + slotsPerTaskManager + '}';
    }
    ...
    public static class ClusterSpecificationBuilder {
        ...
        public ClusterSpecification createClusterSpecification() {
             ...
             *  注释：
             */
            return new ClusterSpecification(masterMemoryMB, taskManagerMemoryMB, slotsPerTaskManager);
        }
    }
}
