...
public class CliFrontendParser {
    ...
    public static final Option STOP_AND_DRAIN = new Option("d", "drain", false, "Send MAX_WATERMARK before taking the savepoint and stopping the pipelne.");
    ...
    public static void printHelpForRunApplication(Collection<CustomCommandLine> customCommandLines) {
        ...
        // in the future
        List<CustomCommandLine> filteredCommandLines = customCommandLines.stream().filter((cli) -> cli instanceof GenericCLI).collect(Collectors.toList());
