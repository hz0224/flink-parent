...
public class StreamContextEnvironment extends StreamExecutionEnvironment {
    ...
    public StreamContextEnvironment(final PipelineExecutorServiceLoader executorServiceLoader,
            ...
            final boolean enforceSingleJobExecution, final boolean suppressSysout) {
    ...
    public JobExecutionResult execute(StreamGraph streamGraph) throws Exception {
        ...
        try {
            ...
            jobListeners
                    .forEach(jobListener -> jobListener.onJobExecuted(null, ExceptionUtils.stripExecutionException(t)));
    ...
    private JobExecutionResult getJobExecutionResult(final JobClient jobClient) throws Exception {
        ...
        if(getConfiguration().getBoolean(DeploymentOptions.ATTACHED)) {
            ...
            if(getConfiguration().getBoolean(DeploymentOptions.SHUTDOWN_IF_ATTACHED)) {
                ...
                jobExecutionResultFuture.whenComplete((ignored, throwable) -> ShutdownHookUtil
                        .removeShutdownHook(shutdownHook, StreamContextEnvironment.class.getSimpleName(), LOG));
            }
    ...
    public static void setAsContext(final PipelineExecutorServiceLoader executorServiceLoader,
        ...
        StreamExecutionEnvironmentFactory factory = conf -> {
            ...
            /*************************************************
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： 构建 StreamContextEnvironment
             */
            return new StreamContextEnvironment(executorServiceLoader, mergedConfiguration, userCodeClassLoader,
