...
/**
 * // TODO_MA 注释： 内存页，无需关心 MemorySegment 内部的读取和写入细节，相当于是封装了 MemorySegment
 * This interface defines a view over some memory that can be used to sequentially read the contents
 * of the memory. The view is typically backed by one or more {@link org.apache.flink.core.memory.MemorySegment}.
 */
@Public
