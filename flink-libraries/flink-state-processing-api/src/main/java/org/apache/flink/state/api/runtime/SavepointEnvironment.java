...
public class SavepointEnvironment implements Environment {
    ...
    private SavepointEnvironment(RuntimeContext ctx, Configuration configuration, int maxParallelism, int indexOfSubtask,
    ...
    public TaskInfo getTaskInfo() {
        return new TaskInfo(ctx.getTaskName(), maxParallelism, indexOfSubtask, ctx.getNumberOfParallelSubtasks(),
    ...
    public static class Builder {
        ...
        public SavepointEnvironment build() {
            return new SavepointEnvironment(ctx, configuration, maxParallelism, indexOfSubtask,
