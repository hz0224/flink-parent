...
public class KvStateClientProxyImpl extends AbstractServerBase<KvStateRequest, KvStateResponse> implements KvStateClientProxy {
     ...
     */
    public KvStateClientProxyImpl(final String bindAddress, final Iterator<Integer> bindPortIterator,
            final Integer numEventLoopThreads, final Integer numQueryThreads, final KvStateRequestStats stats) {
    ...
    public KvStateLocationOracle getKvStateLocationOracle(JobID jobId) {
        final KvStateLocationOracle legacyKvStateLocationOracle = kvStateLocationOracles
                .get(HighAvailabilityServices.DEFAULT_JOB_ID);
    ...
    public AbstractServerHandler<KvStateRequest, KvStateResponse> initializeHandler() {
        MessageSerializer<KvStateRequest, KvStateResponse> serializer = new MessageSerializer<>(
                new KvStateRequest.KvStateRequestDeserializer(), new KvStateResponse.KvStateResponseDeserializer());
