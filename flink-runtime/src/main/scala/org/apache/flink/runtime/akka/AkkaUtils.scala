...
object AkkaUtils {
            ...
            case Some((externalHostname, externalPort)) =>
                ...
                bindAddress match {
                    case Some((bindHostname, bindPort)) =>
                        ...
                        val remoteConfig = getRemoteAkkaConfig(configuration, bindHostname, bindPort, externalHostname, externalPort)
     ...
     */
    private def getRemoteAkkaConfig(configuration: Configuration, bindAddress: String, port: Int, externalHostname: String, externalPort: Int): Config = {
        ...
        val akkaSSLKeyPassword = configuration.getString(SecurityOptions.SSL_INTERNAL_KEY_PASSWORD, configuration.getString(SecurityOptions.SSL_KEY_PASSWORD))
