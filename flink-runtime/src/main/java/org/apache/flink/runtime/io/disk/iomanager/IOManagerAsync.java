...
public class IOManagerAsync extends IOManager implements UncaughtExceptionHandler {
    ...
    /**
     * // TODO_MA 注释： 构造一个新的异步I / O管理器，跨给定目录编写文件轮循。
    ...
    public BufferFileSegmentReader createBufferFileSegmentReader(FileIOChannel.ID channelID,
        ...
        return new AsynchronousBufferFileSegmentReader(channelID, readers[channelID.getThreadNum()].requestQueue,
                callback);
    }
                ...
                while(!this.requestQueue.isEmpty()) {
                    ...
                    if(request != null) {
                        try {
                            ...
                            IOManagerAsync.LOG
                                    .error("The handler of the request complete callback threw an exception" + (t
                                            .getMessage() == null ? "." : ": " + t.getMessage()), t);
                        }
                    }
                }
            }
        ...
        public void run() {
            ...
            while(alive) {
                ...
                try {
                    ...
                    IOManagerAsync.LOG
                            .error("I/O reading thread encountered an error" + (t.getMessage() == null ? "." : ": " + t
                                    .getMessage()), t);
                }
                ...
                try {
                    ...
                    IOManagerAsync.LOG.error("The handler of the request-complete-callback threw an exception" + (t
                            .getMessage() == null ? "." : ": " + t.getMessage()), t);
                }
            } // end while alive
        }
        ...
        public void run() {
            ...
            while(this.alive) {
                ...
                try {
                    ...
                    IOManagerAsync.LOG
                            .error("I/O writing thread encountered an error" + (t.getMessage() == null ? "." : ": " + t
                                    .getMessage()), t);
                }
