...
public class ResultPartitionDeploymentDescriptor implements Serializable {
    ...
    public ResultPartitionDeploymentDescriptor(PartitionDescriptor partitionDescriptor,
            ShuffleDescriptor shuffleDescriptor, int maxParallelism, boolean sendScheduleOrUpdateConsumersMessage) {
    ...
    public String toString() {
        return String.format("ResultPartitionDeploymentDescriptor [PartitionDescriptor: %s, " + "ShuffleDescriptor: %s]",
