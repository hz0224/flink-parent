...
public class RemoteRecoveredInputChannel extends RecoveredInputChannel {
    ...
    RemoteRecoveredInputChannel(SingleInputGate inputGate, int channelIndex, ResultPartitionID partitionId,
        ...
        super(inputGate, channelIndex, partitionId, initialBackOff, maxBackoff, metrics.getNumBytesInRemoteCounter(),
                metrics.getNumBuffersInRemoteCounter(), networkBuffersPerChannel);
    ...
    protected InputChannel toInputChannelInternal() throws IOException {
         ...
         *  注释： 得到 RemoteInputChannel
         */
        RemoteInputChannel remoteInputChannel = new RemoteInputChannel(inputGate, getChannelIndex(), partitionId,
                connectionId, connectionManager, initialBackoff, maxBackoff, networkBuffersPerChannel, numBytesIn,
                numBuffersIn, channelStateWriter);
