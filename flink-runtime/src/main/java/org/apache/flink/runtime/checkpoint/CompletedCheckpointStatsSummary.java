...
public class CompletedCheckpointStatsSummary implements Serializable {
    ...
    private CompletedCheckpointStatsSummary(MinMaxAvgStats stateSize, MinMaxAvgStats duration,
            MinMaxAvgStats processedData, MinMaxAvgStats persistedData) {
    ...
    CompletedCheckpointStatsSummary createSnapshot() {
        return new CompletedCheckpointStatsSummary(stateSize.createSnapshot(), duration.createSnapshot(),
                processedData.createSnapshot(), persistedData.createSnapshot());
    }
