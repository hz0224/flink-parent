...
interface ChannelStateWriteRequest {
    ...
    static CheckpointInProgressRequest completeInput(long checkpointId) {
         ...
         *  注释：
         */
        return new CheckpointInProgressRequest("completeInput", checkpointId, ChannelStateCheckpointWriter::completeInput,
                false);
    }
    ...
    static CheckpointInProgressRequest completeOutput(long checkpointId) {
         ...
         *  注释：
         */
        return new CheckpointInProgressRequest("completeOutput", checkpointId,
                ChannelStateCheckpointWriter::completeOutput, false);
    }
    ...
    static ChannelStateWriteRequest write(long checkpointId, InputChannelInfo info, CloseableIterator<Buffer> iterator) {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 返回的是： CheckpointInProgressRequest
         */
    ...
    static ChannelStateWriteRequest write(long checkpointId, ResultSubpartitionInfo info, Buffer... buffers) {
         ...
         *  注释：
         */
        return buildWriteRequest(checkpointId, "writeOutput", ofElements(Buffer::recycleBuffer, buffers),
                (writer, buffer) -> writer.writeOutput(info, buffer));
    }

    static ChannelStateWriteRequest buildWriteRequest(long checkpointId, String name, CloseableIterator<Buffer> iterator,
    ...
    static ChannelStateWriteRequest start(long checkpointId, ChannelStateWriteResult targetResult,
...
final class CheckpointStartRequest implements ChannelStateWriteRequest {
    ...
    CheckpointStartRequest(long checkpointId, ChannelStateWriteResult targetResult,
            CheckpointStorageLocationReference locationReference) {
...
final class CheckpointInProgressRequest implements ChannelStateWriteRequest {
    ...
    CheckpointInProgressRequest(String name, long checkpointId,
            ThrowingConsumer<ChannelStateCheckpointWriter, Exception> action, boolean ignoreMissingWriter) {
    ...
    CheckpointInProgressRequest(String name, long checkpointId,
            ...
            ThrowingConsumer<Throwable, Exception> discardAction, boolean ignoreMissingWriter) {
        this.checkpointId = checkpointId;
