...
public final class QueryableStateUtils {
     ...
     */
    public static KvStateClientProxy createKvStateClientProxy(final String address, final Iterator<Integer> ports,
            final int eventLoopThreads, final int queryThreads, final KvStateRequestStats stats) {
        ...
        try {
             ...
             *  注释： 通过反射构建一个： KvStateClientProxyImpl
             */
            ...
            Constructor<? extends KvStateClientProxy> constructor = clazz
                    .getConstructor(String.class, Iterator.class, Integer.class, Integer.class,
     ...
     */
    public static KvStateServer createKvStateServer(final String address, final Iterator<Integer> ports,
            final int eventLoopThreads, final int queryThreads, final KvStateRegistry kvStateRegistry,
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 通过反射构建一个 KvStateServerImpl 实例
         */
        try {
            ...
            Constructor<? extends KvStateServer> constructor = clazz
                    .getConstructor(String.class, Iterator.class, Integer.class, Integer.class, KvStateRegistry.class,
                            KvStateRequestStats.class);
