...
public class ZooKeeperHaServices extends AbstractHaServices {
    ...
    // TODO_MA 注释： ResourceManager 的 Leader 选举分布式锁 znode 节点
    private static final String RESOURCE_MANAGER_LEADER_PATH = "/resource_manager_lock";

    // TODO_MA 注释： Dispatcher 的 Leader 选举分布式锁 znode 节点
    private static final String DISPATCHER_LEADER_PATH = "/dispatcher_lock";

    // TODO_MA 注释： JobManager 的 Leader 选举分布式锁 znode 节点
    private static final String JOB_MANAGER_LEADER_PATH = "/job_manager_lock";

    // TODO_MA 注释： RestServer(接收 client 提交 job 的服务端) 的 Leader 选举分布式锁 znode 节点
     ...
     * // TODO_MA 注释： ZooKeeper 客户端，通过 Curator 来实现
     */
    ...
    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： 通过 如下的 四个 getLeaderNameForXXX 方法可以得知：
     *  1、ResourceManager 和 Dispatcher 和 RestServer 都只要一个
     *  2、但是 JobManager 有多个，并且是一个 Job 对应一个 JobManager
     */
