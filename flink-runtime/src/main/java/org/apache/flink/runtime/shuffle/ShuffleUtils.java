...
public class ShuffleUtils {
    ...
    public static <T, SD extends ShuffleDescriptor> T applyWithShuffleTypeCheck(Class<SD> shuffleDescriptorClass,
            ShuffleDescriptor shuffleDescriptor, Function<UnknownShuffleDescriptor, T> functionOfUnknownDescriptor,
        ...
        if(shuffleDescriptor.isUnknown()) {
            ...
            throw new IllegalArgumentException(
                    String.format("Unsupported ShuffleDescriptor type <%s>, only <%s> is supported",
                            shuffleDescriptor.getClass().getName(), shuffleDescriptorClass.getName()));
        }
    }
}
