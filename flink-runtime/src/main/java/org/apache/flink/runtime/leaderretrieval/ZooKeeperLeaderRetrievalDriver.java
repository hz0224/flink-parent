...
public class ZooKeeperLeaderRetrievalDriver implements LeaderRetrievalDriver, NodeCacheListener, UnhandledErrorListener {
     ...
     */
    public ZooKeeperLeaderRetrievalDriver(CuratorFramework client, String retrievalPath, LeaderRetrievalEventHandler leaderRetrievalEventHandler,
            FatalErrorHandler fatalErrorHandler) throws Exception {

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释：
         *  1、CuratorFramework = ZooKeeper API 框架： Curator， 它的内部封装了一个 ZooKeeper 类
         */
        this.client = checkNotNull(client, "CuratorFramework client");

        // TODO_MA 注释： NodeCache
        // TODO_MA 注释： Watcher （监听的是znode节点的数据变化）
         ...
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 开启监听
         *  由于 cache 是 NodeCache ，所以监听的是 znode 节点数据变化。
         *  所以当 cache 响应，则会回调 cache 的 nodeChanded() 方法
         */
    ...
    public void unhandledError(String s, Throwable throwable) {
        fatalErrorHandler.onFatalError(new LeaderRetrievalException("Unhandled error in ZooKeeperLeaderRetrievalDriver:" + s, throwable));
    }
