...
public abstract class ResultPartition implements ResultPartitionWriter {
    ...
    /**
     * // TODO_MA 注释： ResultPartition 的类型
     ...
     *  注释： 关于这个对象，ResultPartitionManager，它的初始化，是在创建 NettyShuffleEnvironment 的时候初始化的
     *  当前这个从节点，只有这么一个对象。
     *  正常来说，这个从节点，上肯定是会运行很多的Task， 每个Task 都有一到多个 ResultPartitioin  的
     */
    ...
    public ResultPartition(String owningTaskName, int partitionIndex, ResultPartitionID partitionId,
            ResultPartitionType partitionType, int numSubpartitions, int numTargetKeyGroups,
    ...
    public void setup() throws IOException {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 注意，每个 TaskExecutor 都有一个 ResultPartitionManager ，负责管理这个节点上的各个 Task 的 ResultPartition 组件
         *  这个 ResultPartitionManager 是在创建 NettyShuffleEnvironment 的时候创建的
         *  -
         *  因为当前这个节点上，只有一个 NettyClietn 和 NettyServer
         *  所以，NettyClietn 和 NettyServer 会为所有的 Task 进行服务
         */
    ...
    public String toString() {
        return "ResultPartition " + partitionId
                .toString() + " [" + partitionType + ", " + numSubpartitions + " subpartitions]";
    }
