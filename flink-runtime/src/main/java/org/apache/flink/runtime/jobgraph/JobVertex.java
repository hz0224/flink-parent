...
public class JobVertex implements java.io.Serializable {
    ...
    public JobEdge connectNewDataSetAsInput(JobVertex input, DistributionPattern distPattern,
        ...
        // TODO_MA 注释： 创建 IntermediateDataSet
        IntermediateDataSet dataSet = input.createAndAddResultDataSet(partitionType);

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 创建 JobEdge
         *  1、source  = IntermediateDataSet
         *  2、target = JobVertex
         */
        JobEdge edge = new JobEdge(dataSet, this, distPattern);
    ...
    public boolean isInputVertex() {
        ...
        // TODO_MA 注释： 如果某个 JobVertex 没有输入，则意味着是 Source StreamNode
