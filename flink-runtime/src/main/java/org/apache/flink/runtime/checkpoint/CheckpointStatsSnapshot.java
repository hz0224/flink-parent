...
public class CheckpointStatsSnapshot implements Serializable {
     ...
     */
    CheckpointStatsSnapshot(CheckpointStatsCounts counts, CompletedCheckpointStatsSummary summary,
            CheckpointStatsHistory history, @Nullable RestoredCheckpointStats latestRestoredCheckpoint) {
