...
public final class RestartBackoffTimeStrategyFactoryLoader {
    ...
    public static RestartBackoffTimeStrategy.Factory createRestartBackoffTimeStrategyFactory(
            ...
            final Configuration clusterConfiguration, final boolean isCheckpointingEnabled) {
    ...
    private static Optional<RestartBackoffTimeStrategy.Factory> getJobRestartStrategyFactory(
        ...
        // TODO_MA 注释： NoRestartBackoffTimeStrategyFactory
        ...
        // TODO_MA 注释： FixedDelayRestartBackoffTimeStrategyFactory
        ...
        // TODO_MA 注释： FailureRateRestartBackoffTimeStrategyFactory
            ...
            return Optional.of(new FailureRateRestartBackoffTimeStrategy.FailureRateRestartBackoffTimeStrategyFactory(
                    failureRateConfig.getMaxFailureRate(), failureRateConfig.getFailureInterval().toMilliseconds(),
