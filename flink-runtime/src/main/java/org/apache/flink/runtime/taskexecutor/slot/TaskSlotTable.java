...
// TODO_MA 注释： TaskSlotTable 是 TaskExecutor中的一个成员变量
// TODO_MA 注释： 是真正帮助 TaskExecutor 完成 一切跟 Slot 有关的操作的！

// TODO_MA 注释： 在 ResourceManager 中也有一个类似的组件： SlotManager
public interface TaskSlotTable<T extends TaskSlotPayload> extends TimeoutListener<AllocationID>, AutoCloseableAsync {
     ...
     * @return True if the task slot could be allocated; otherwise false
     */
    boolean allocateSlot(int index, JobID jobId, AllocationID allocationId, ResourceProfile resourceProfile, Time slotTimeout);
