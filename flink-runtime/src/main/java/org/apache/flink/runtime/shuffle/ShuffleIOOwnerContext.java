...
public class ShuffleIOOwnerContext {
    ...
    public ShuffleIOOwnerContext(String ownerName, ExecutionAttemptID executionAttemptID, MetricGroup parentGroup,
            MetricGroup outputGroup, MetricGroup inputGroup) {
