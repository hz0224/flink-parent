 ...
 *
 * // TODO_MA 注释： 涉及到的一些 netty 的操作逻辑，被封装在 AbstractReferenceCountedByteBuf 抽象类中
 * // TODO_MA 注释： AbstractReferenceCountedByteBuf 本身也是 Netty 提供的一个组件
 */
public class NetworkBuffer extends AbstractReferenceCountedByteBuf implements Buffer {
     ...
     */
    public NetworkBuffer(MemorySegment memorySegment, BufferRecycler recycler, DataType dataType, boolean isCompressed,
            int size) {
    ...
    public String toString() {
        ...
        StringBuilder buf = new StringBuilder().append("Buffer ").append(hashCode()).append(" (ridx: ")
