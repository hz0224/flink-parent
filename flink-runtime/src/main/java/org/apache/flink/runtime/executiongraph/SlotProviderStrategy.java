...
public abstract class SlotProviderStrategy {
     ...
     */
    public abstract CompletableFuture<LogicalSlot> allocateSlot(SlotRequestId slotRequestId,
     ...
     */
    public void cancelSlotRequest(SlotRequestId slotRequestId, @Nullable SlotSharingGroupId slotSharingGroupId,
            Throwable cause) {
        slotProvider.cancelSlotRequest(slotRequestId, slotSharingGroupId, cause);
    }

    public static SlotProviderStrategy from(ScheduleMode scheduleMode, SlotProvider slotProvider,
    ...
    static class BatchSlotProviderStrategy extends SlotProviderStrategy {
        ...
        @Override
        public CompletableFuture<LogicalSlot> allocateSlot(SlotRequestId slotRequestId, ScheduledUnit scheduledUnit,
