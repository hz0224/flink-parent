...
/**
 * // TODO_MA 注释： 分区队列的nonEmptyReader，它在写入和刷新{@link Buffer}实例之前侦听通道可写性更改的事件。
...
class PartitionRequestQueue extends ChannelInboundHandlerAdapter {
    ...
    /**
     * // TODO_MA 注释： 包含了一个可以从中读取数据的 NetworkSequenceViewReader 队列，它会监听 Netty Channel 的可写入状态，
     * // TODO_MA 注释： 一旦可以写入数据，就会从 NetworkSequenceViewReader 消费数据写入 Netty Channel。
    ...
    /**
     * // TODO_MA 注释： 持有所有请求消费数据的 RemoteInputChannel 的 ID 和 NetworkSequenceViewReader 之间的映射关系。
    ...
    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： msg = NetworkSequenceViewReader
     */
    @Override
    ...
    private void writeAndFlushNextMessageIfPossible(final Channel channel) throws IOException {
        ...
        try {
            while(true) {
                ...
                /*************************************************
                 * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
                 *  注释： 获取出来那个可用的 NetworkSequenceViewReader
                 */
                ...
                // TODO_MA 注释： 获取数据
                // TODO_MA 注释： next 就是从 Buffers 中获取的数据
                ...
                if(next == null) {
                    ...
                    BufferResponse msg = new BufferResponse(next.buffer(), next.getSequenceNumber(),
                            reader.getReceiverId(), next.buffersInBacklog());

                    /*************************************************
                     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
                     *  注释： flush 数据
                     *  此处，真正完成， 从 NettyServer 写一条数据到 NettyClient
                     *  此时，代码去： NettyClient 绑定的那个 Handler
                     */
