...
public class DispatcherRestEndpoint extends WebMonitorEndpoint<DispatcherGateway> {
     ...
     *  注释： 创建一个 DispatcherRestEndpoint 实例，它是 WebMonitorEndpoint 的子类
     */
    public DispatcherRestEndpoint(RestServerEndpointConfiguration endpointConfiguration, GatewayRetriever<DispatcherGateway> leaderRetriever,
        ...
        // TODO_MA 注释： 调用 WebMonitorEndpoint 的构造方法
        super(endpointConfiguration, leaderRetriever, clusterConfiguration, restConfiguration, resourceManagerRetriever, transientBlobService, executor,
                metricFetcher, leaderElectionService, executionGraphCache, fatalErrorHandler);
        ...
        if(restConfiguration.isWebSubmitEnabled()) {
            try {
                ...
                webSubmissionExtension = WebMonitorUtils
                        .loadWebSubmissionExtension(leaderRetriever, timeout, responseHeaders, localAddressFuture, uploadDir, executor, clusterConfiguration);
