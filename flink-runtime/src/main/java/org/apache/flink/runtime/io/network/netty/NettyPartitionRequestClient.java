...
public class NettyPartitionRequestClient implements PartitionRequestClient {
    ...
    NettyPartitionRequestClient(Channel tcpChannel, NetworkClientHandler clientHandler, ConnectionID connectionId,
     ...
     */
    @Override
    public void requestSubpartition(final ResultPartitionID partitionId, final int subpartitionIndex,
        ...
        // TODO_MA 注释： 向 CreditBasedPartitionRequestClientHandler 注册当前 RemoteInputChannel
        clientHandler.addInputChannel(inputChannel);

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 发送 PartitionRequest 请求给 NettyServer
         */
        ...
        if(delayMs == 0) {
            ...
            /*************************************************
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： 服务端 Handler 执行处理： PartitionRequestServerHandler
             *  这个 NettyRequest 写入到了 NettyServer
             *  NettyServer 和 NettyClient 其实在从节点启动的时候，就已经启动了。
             */
     ...
     */
    @Override
    public void sendTaskEvent(ResultPartitionID partitionId, TaskEvent event,
