...
public class HeartbeatServices {
    ...
    public <I, O> HeartbeatManager<I, O> createHeartbeatManager(ResourceID resourceId, HeartbeatListener<I, O> heartbeatListener,
         ...
         *  注释：
         *  HeartbeatManagerSenderImpl 心跳请求发送器 Client
         *      在这个对象的构造方法的内部，初始化了一个 定时服务
         *      每隔 10s 中向所有的心跳目标对象，发送心跳请求！
         *  HeartbeatManagerImpl 心跳请求处理器    Server
         */
    ...
    /**
     * // TODO_MA 注释：  ResourceManager 和 TaskExecutor
     * // TODO_MA 注释：  ResourceManager 和 JobMaster
     *      * // TODO_MA 注释：  TaskExecutor 和 JobMaster
