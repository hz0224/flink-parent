...
public class CheckpointStatsCounts implements Serializable {
     ...
     */
    private CheckpointStatsCounts(long numRestoredCheckpoints, long numTotalCheckpoints, int numInProgressCheckpoints,
            long numCompletedCheckpoints, long numFailedCheckpoints) {
    ...
    CheckpointStatsCounts createSnapshot() {
        return new CheckpointStatsCounts(numRestoredCheckpoints, numTotalCheckpoints, numInProgressCheckpoints,
                numCompletedCheckpoints, numFailedCheckpoints);
    }
