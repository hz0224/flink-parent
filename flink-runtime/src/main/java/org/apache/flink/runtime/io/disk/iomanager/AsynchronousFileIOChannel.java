...
final class SegmentReadRequest implements ReadRequest {
    ...
    protected SegmentReadRequest(AsynchronousFileIOChannel<MemorySegment, ReadRequest> targetChannel,
...
final class FileSegmentReadRequest implements ReadRequest {
    ...
    protected FileSegmentReadRequest(AsynchronousFileIOChannel<FileSegment, ReadRequest> targetChannel,
            AtomicBoolean hasReachedEndOfFile) {
        this.channel = targetChannel;
        this.hasReachedEndOfFile = hasReachedEndOfFile;
    }
