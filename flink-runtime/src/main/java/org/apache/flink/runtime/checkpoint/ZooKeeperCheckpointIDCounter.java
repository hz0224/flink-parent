    ...
    public void start() throws Exception {
        synchronized(startStopLock) {
            if(!isStarted) {
                ...
                // TODO_MA 注释： connectionStateListener = DefaultLastStateConnectionStateListener
    ...
    public long getAndIncrement() throws Exception {
        while(true) {
            ...
            if(newCount < 0) {
                ...
                throw new Exception(
                        "Checkpoint counter overflow. ZooKeeper checkpoint counter only supports " + "checkpoints Ids up to " + Integer.MAX_VALUE);
            }
    ...
    public void setCount(long newId) throws Exception {
        ...
        if(newId > Integer.MAX_VALUE) {
            throw new IllegalArgumentException(
                    "ZooKeeper checkpoint counter only supports " + "checkpoints Ids up to " + Integer.MAX_VALUE + ", but given value is" + newId);
        }
