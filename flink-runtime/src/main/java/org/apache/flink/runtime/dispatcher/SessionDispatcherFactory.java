...
public enum SessionDispatcherFactory implements DispatcherFactory {
    ...
    @Override
    public StandaloneDispatcher createDispatcher(RpcService rpcService, DispatcherId fencingToken, Collection<JobGraph> recoveredJobs,
        ...
        return new StandaloneDispatcher(rpcService, fencingToken, recoveredJobs, dispatcherBootstrapFactory,

                // TODO_MA 注释： 构建 DispatcherServices
