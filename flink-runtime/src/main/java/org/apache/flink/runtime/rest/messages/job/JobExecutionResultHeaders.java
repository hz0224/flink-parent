 ...
 */
public class JobExecutionResultHeaders implements MessageHeaders<EmptyRequestBody, JobExecutionResultResponseBody, JobMessageParameters> {

    // TODO_MA 注释： 获取 job 执行结果的请求头 对象
    ...
    public String getDescription() {
        return "Returns the result of a job execution. Gives access to the execution time of the job " + "and to all accumulators created by this job.";
    }
}
