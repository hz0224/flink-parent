...
public class FsCheckpointStorageLocation extends FsCheckpointStreamFactory implements CheckpointStorageLocation {
    ...
    public FsCheckpointStorageLocation(FileSystem fileSystem, Path checkpointDir, Path sharedStateDir,
            Path taskOwnedStateDir, CheckpointStorageLocationReference reference, int fileStateSizeThreshold,
            int writeBufferSize) {
