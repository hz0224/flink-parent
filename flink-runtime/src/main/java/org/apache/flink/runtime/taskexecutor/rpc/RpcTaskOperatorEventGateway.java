...
public class RpcTaskOperatorEventGateway implements TaskOperatorEventGateway {
    ...
    public RpcTaskOperatorEventGateway(JobMasterOperatorEventGateway rpcGateway, ExecutionAttemptID taskExecutionId,
    ...
    public void sendOperatorEventToCoordinator(OperatorID operator, SerializedValue<OperatorEvent> event) {
         ...
         *  注释：
         */
        final CompletableFuture<Acknowledge> result = rpcGateway
                .sendOperatorEventToCoordinator(taskExecutionId, operator, event);
