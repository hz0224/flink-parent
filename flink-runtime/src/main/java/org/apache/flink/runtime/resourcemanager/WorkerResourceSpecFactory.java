...
public abstract class WorkerResourceSpecFactory {
    ...
    protected WorkerResourceSpec workerResourceSpecFromConfigAndCpu(Configuration configuration,
        ...
        final TaskExecutorProcessSpec taskExecutorProcessSpec = TaskExecutorProcessUtils
                .newProcessSpecBuilder(configuration).withCpuCores(cpuResource).build();
