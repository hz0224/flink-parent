...
public class NettyProtocol {
    ...
    public ChannelHandler[] getServerChannelHandlers() {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 负责处理消费端通过 PartitionRequestClient 发送的 PartitionRequest 和 AddCredit 请求
         */
        PartitionRequestServerHandler serverHandler = new PartitionRequestServerHandler(partitionProvider,
                taskEventPublisher, queueOfPartitionQueues);
    ...
    public ChannelHandler[] getClientChannelHandlers() {
         ...
         *  注释： 封装一下
         */
        return new ChannelHandler[]{messageEncoder, new NettyMessageClientDecoderDelegate(
