...
public class ResourceManagerRuntimeServices {
    ...
    public static ResourceManagerRuntimeServices fromConfiguration(
            ResourceManagerRuntimeServicesConfiguration configuration, HighAvailabilityServices highAvailabilityServices,
            ScheduledExecutor scheduledExecutor, SlotManagerMetricGroup slotManagerMetricGroup) {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 生成一个 ResourceManagerRuntimeServices
         */
    ...
    private static SlotManager createSlotManager(ResourceManagerRuntimeServicesConfiguration configuration,
        ...
        if(configuration.isDeclarativeResourceManagementEnabled()) {
            return new DeclarativeSlotManager(scheduledExecutor, configuration.getSlotManagerConfiguration(),
                    slotManagerMetricGroup, new DefaultResourceTracker(), new DefaultSlotTracker());
        } else {
