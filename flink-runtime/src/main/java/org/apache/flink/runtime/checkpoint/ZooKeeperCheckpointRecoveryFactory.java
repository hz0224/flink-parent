...
public class ZooKeeperCheckpointRecoveryFactory implements CheckpointRecoveryFactory {
    ...
    @Override
    public CompletedCheckpointStore createCheckpointStore(JobID jobId, int maxNumberOfCheckpointsToRetain,
            ClassLoader userClassLoader) throws Exception {

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： DefaultCompletedCheckpointStore
         */
        return ZooKeeperUtils.createCompletedCheckpoints(client, config, jobId, maxNumberOfCheckpointsToRetain, executor);
    }
    ...
    public CheckpointIDCounter createCheckpointIDCounter(JobID jobID) throws Exception {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： ZooKeeperCheckpointIDCounter
         */
