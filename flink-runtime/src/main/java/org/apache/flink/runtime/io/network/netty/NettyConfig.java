...
public class NettyConfig {
    ...
    public NettyConfig(InetAddress serverAddress, int serverPort, int memorySegmentSize, int numberOfSlots,
    ...
    public boolean getSSLEnabled() {
        return config.getBoolean(NettyShuffleEnvironmentOptions.DATA_SSL_ENABLED) && SSLUtils
                .isInternalSSLEnabled(config);
    }
    ...
    public String toString() {
        ...
        return String.format(format, serverAddress, serverPort, getSSLEnabled() ? "true" : "false", memorySegmentSize,
                getTransportType(), getServerNumThreads(), getServerNumThreads() == 0 ? def : man,
                getClientNumThreads(), getClientNumThreads() == 0 ? def : man, getServerConnectBacklog(),
                getServerConnectBacklog() == 0 ? def : man, getClientConnectTimeoutSeconds(),
