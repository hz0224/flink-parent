...
public class InputOutputFormatVertex extends JobVertex {
    ...
    public void initializeOnMaster(ClassLoader loader) throws Exception {
        ...
        try {
            ...
            Map<OperatorID, UserCodeWrapper<? extends InputFormat<?, ?>>> inputFormats = formatContainer
                    .getInputFormats();
            ...
            for(Map.Entry<OperatorID, UserCodeWrapper<? extends InputFormat<?, ?>>> entry : inputFormats.entrySet()) {
                ...
                try {
                    ...
                    throw new Exception(
                            "Configuring the input format (" + getFormatDescription(entry.getKey()) + ") failed: " + t
                                    .getMessage(), t);
                }
            ...
            Map<OperatorID, UserCodeWrapper<? extends OutputFormat<?>>> outputFormats = formatContainer
                    .getOutputFormats();
            for(Map.Entry<OperatorID, UserCodeWrapper<? extends OutputFormat<?>>> entry : outputFormats.entrySet()) {
                ...
                try {
                    ...
                    throw new Exception(
                            "Configuring the output format (" + getFormatDescription(entry.getKey()) + ") failed: " + t
                                    .getMessage(), t);
                }
    ...
    private InputOutputFormatContainer initInputOutputformatContainer(ClassLoader classLoader) throws Exception {
        try {
            ...
            throw new Exception(
                    "Loading the input/output formats failed: " + String.join(",", formatDescriptions.values()), t);
        }
    }
}
