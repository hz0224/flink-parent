...
public class SortMergeResultPartition extends ResultPartition {
    ...
    public SortMergeResultPartition(String owningTaskName, int partitionIndex, ResultPartitionID partitionId,
            ResultPartitionType partitionType, int numSubpartitions, int numTargetKeyGroups, int networkBufferSize,
            ResultPartitionManager partitionManager, String resultFileBasePath,
            @Nullable BufferCompressor bufferCompressor,
            SupplierWithException<BufferPool, IOException> bufferPoolFactory) {

        super(owningTaskName, partitionIndex, partitionId, partitionType, numSubpartitions, numTargetKeyGroups,
    ...
    private SortBuffer getSortBuffer() {
        ...
        currentSortBuffer = new PartitionSortedBuffer(lock, bufferPool, numSubpartitions, networkBufferSize, null);
        return currentSortBuffer;
    }
    ...
    public ResultSubpartitionView createSubpartitionView(int subpartitionIndex,
        ...
        synchronized(lock) {
            ...
            SortMergeSubpartitionReader reader = new SortMergeSubpartitionReader(subpartitionIndex,
                    numDataBuffers[subpartitionIndex], networkBufferSize, this, availabilityListener, resultFile);
            readers.add(reader);
