...
public class EventSerializer {
    ...
    public static ByteBuffer toSerializedEvent(AbstractEvent event) throws IOException {
        ...
        if(eventClass == EndOfPartitionEvent.class) {
            ...
            ByteBuffer serializedAnnouncement = ByteBuffer
                    .allocate(2 * Integer.BYTES + serializedAnnouncedEvent.capacity());
                ...
                try {
                    ...
                    try {
                        ...
                        throw new IOException(
                                "The class '" + className + "' is not a valid subclass of '" + AbstractEvent.class
                                        .getName() + "'.", e);
                    }
    ...
    private static ByteBuffer serializeCheckpointBarrier(CheckpointBarrier barrier) throws IOException {
        ...
        final byte[] locationBytes = checkpointOptions.getTargetLocation().isDefaultReference() ? null : checkpointOptions
                .getTargetLocation().getReferenceBytes();
