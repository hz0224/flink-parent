 ...
 *
 * // TODO_MA 注释： LeaderContender 是一个 竞选角色
 * // TODO_MA 注释： leaderElectionService.start(LeaderContender)
 * // TODO_MA 注释： 如果成功：则回调 leaderElectionService 的 isLeader() 方法
 *                      // TODO_MA 注释： isLeader() 的方法的内部回调： LeaderContender 的 grantLeaderShip()
 * // TODO_MA 注释： 如果失败：则回调 leaderElectionService 的 notLeader() 方法
 */
