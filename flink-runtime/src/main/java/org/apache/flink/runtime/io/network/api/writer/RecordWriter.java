...
public abstract class RecordWriter<T extends IOReadableWritable> implements AvailabilityProvider {
    ...
    // TODO_MA 注释： 底层的 ResultPartition
    protected final ResultPartitionWriter targetPartition;

    // TODO_MA 注释： channel的数量，即 sub-partition的数量
    ...
    RecordWriter(ResultPartitionWriter writer, long timeout, String taskName) {
        ...
        if(timeout == -1 || timeout == 0) {
            ...
            String threadName = taskName == null ? DEFAULT_OUTPUT_FLUSH_THREAD_NAME : DEFAULT_OUTPUT_FLUSH_THREAD_NAME + " for " + taskName;
    ...
    public void broadcastEvent(AbstractEvent event, boolean isPriorityEvent) throws IOException {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 往目标分区发送 CheckpointBarrier 消息
         */
    ...
    protected void checkErroneous() throws IOException {
        ...
        if(flusherException != null || (volatileFlusherExceptionCheckSkipCount >= VOLATILE_FLUSHER_EXCEPTION_MAX_CHECK_SKIP_COUNT && volatileFlusherException != null)) {
