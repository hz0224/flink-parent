...
public class NettyShuffleEnvironmentBuilder {
    ...
    public NettyShuffleEnvironment build() {
        ...
        return NettyShuffleServiceFactory.createNettyShuffleEnvironment(
                new NettyShuffleEnvironmentConfiguration(numNetworkBuffers, bufferSize, partitionRequestInitialBackoff,
                        partitionRequestMaxBackoff, networkBuffersPerChannel, floatingNetworkBuffersPerGate,
                        DEFAULT_REQUEST_SEGMENTS_TIMEOUT, false, nettyConfig, DEFAULT_TEMP_DIRS,
                        BoundedBlockingSubpartitionType.AUTO, blockingShuffleCompressionEnabled, compressionCodec,
                        maxBuffersPerChannel, sortShuffleMinBuffers, sortShuffleMinParallelism), taskManagerLocation,
                new TaskEventDispatcher(), resultPartitionManager, metricGroup, ioExecutor);
    }
}
