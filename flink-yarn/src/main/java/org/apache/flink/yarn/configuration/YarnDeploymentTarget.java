...
public enum YarnDeploymentTarget {
    ...
    public static YarnDeploymentTarget fromConfig(final Configuration configuration) {
        ...
        if(deploymentTarget == null) {
            throw new IllegalArgumentException("Unknown Yarn deployment target \"" + deploymentTargetStr + "\"." + " The available options are: " + options());
        }
    ...
    public static boolean isValidYarnTarget(final String configValue) {
        return configValue != null && Arrays.stream(YarnDeploymentTarget.values())
