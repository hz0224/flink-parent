...
public class WatermarkAssignerOperatorFactory extends AbstractStreamOperatorFactory<RowData> implements OneInputStreamOperatorFactory<RowData, RowData> {
    ...
    public WatermarkAssignerOperatorFactory(int rowtimeFieldIndex, long idleTimeout,
    ...
    public StreamOperator createStreamOperator(StreamOperatorParameters initializer) {
        WatermarkGenerator watermarkGenerator = generatedWatermarkGenerator
                .newInstance(initializer.getContainingTask().getUserCodeClassLoader());

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释：
         */
        WatermarkAssignerOperator operator = new WatermarkAssignerOperator(rowtimeFieldIndex, watermarkGenerator,
                idleTimeout, processingTimeService);
