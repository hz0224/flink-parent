 ...
 * 这是 StreamTask 中的 SourceTask 的 启动类，启动入口
 */
@Internal
public class SourceOperatorStreamTask<T> extends StreamTask<T, SourceOperator<T, ?>> {
    ...
    public void init() throws Exception {
        ...
        output = new AsyncDataOutputToOutput<>(operatorChain.getMainOperatorOutput(), getStreamStatusMaintainer(), null);
    ...
    public static class AsyncDataOutputToOutput<T> extends AbstractDataOutput<T> {
        ...
        public AsyncDataOutputToOutput(Output<StreamRecord<T>> output, StreamStatusMaintainer streamStatusMaintainer,
