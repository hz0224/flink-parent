...
public final class StreamElementSerializer<T> extends TypeSerializer<StreamElement> {
    ...
    public StreamElementSerializer(TypeSerializer<T> serializer) {
        if(serializer instanceof StreamElementSerializer) {
            throw new RuntimeException(
                    "StreamRecordSerializer given to StreamRecordSerializer as value TypeSerializer: " + serializer);
        }
    ...
    public StreamElement deserialize(DataInputView source) throws IOException {
        ...
        // TODO_MA 注释： 其他情况
            ...
            return new LatencyMarker(source.readLong(), new OperatorID(source.readLong(), source.readLong()),
                    source.readInt());
        } else {
            throw new IOException("Corrupt stream, found tag: " + tag);
        }
    ...
    public static final class StreamElementSerializerConfigSnapshot<T> extends CompositeTypeSerializerConfigSnapshot<StreamElement> {
        ...
        public TypeSerializerSchemaCompatibility<StreamElement> resolveSchemaCompatibility(
            ...
            return CompositeTypeSerializerUtil
                    .delegateCompatibilityCheckToNewSnapshot(newSerializer, new StreamElementSerializerSnapshot<>(),
    ...
    public static final class StreamElementSerializerSnapshot<T> extends CompositeTypeSerializerSnapshot<StreamElement, StreamElementSerializer<T>> {
        ...
        protected StreamElementSerializer<T> createOuterSerializerWithNestedSerializers(
            ...
            @SuppressWarnings("unchecked") TypeSerializer<T> casted = (TypeSerializer<T>) nestedSerializers[0];
