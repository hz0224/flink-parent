...
public class CheckpointConfig implements java.io.Serializable {
    ...
    /**
     * // TODO_MA 注释： 并发的 checkpoint 数量，默认是 1
    ...
    /**
     * // TODO_MA 注释： 是否启用 非对齐 checkpoint 的标识
    ...
    /**
     * // TODO_MA 注释： checkpoint 失败的最大容忍次数，默认是 -1，表示不允许出错，出错就抛异常退出
    ...
    public void setCheckpointInterval(long checkpointInterval) {
        if(checkpointInterval < MINIMAL_CHECKPOINT_TIME) {
            throw new IllegalArgumentException(
                    String.format("Checkpoint interval must be larger than or equal to %s ms", MINIMAL_CHECKPOINT_TIME));
        }
    ...
    public void setCheckpointTimeout(long checkpointTimeout) {
        if(checkpointTimeout < MINIMAL_CHECKPOINT_TIME) {
            throw new IllegalArgumentException(
                    String.format("Checkpoint timeout must be larger than or equal to %s ms", MINIMAL_CHECKPOINT_TIME));
        }
    ...
    public void setFailOnCheckpointingErrors(boolean failOnCheckpointingErrors) {
        if(tolerableCheckpointFailureNumber != UNDEFINED_TOLERABLE_CHECKPOINT_NUMBER) {
            LOG.warn(
                    "Since tolerableCheckpointFailureNumber has been configured as {}, deprecated #setFailOnCheckpointingErrors(boolean) " + "method would not take any effect and please use #setTolerableCheckpointFailureNumber(int) method to " + "determine your expected behaviour when checkpoint errors on task side.",
    ...
    public void configure(ReadableConfig configuration) {
        ...
        // TODO_MA 注释： CheckpointingMode 默认是 CheckpointingMode.EXACTLY_ONCE，也可以指定为 CheckpointingMode.AT_LEAST_ONCE
        // TODO_MA 注释： execution.checkpointing.mode = CheckpointingMode.EXACTLY_ONCE
        configuration.getOptional(ExecutionCheckpointingOptions.CHECKPOINTING_MODE).ifPresent(this::setCheckpointingMode);

        // TODO_MA 注释： execution.checkpointing.interval =5min  10min
        //  不宜过大
        //  不宜过小
        ...
        // TODO_MA 注释： execution.checkpointing.timeout = 10 min
        ...
        // TODO_MA 注释： execution.checkpointing.max-concurrent-checkpoints = 1
        ...
        // TODO_MA 注释： execution.checkpointing.min-pause = ZERO
        ...
        // TODO_MA 注释： execution.checkpointing.prefer-checkpoint-for-recovery = false
        ...
        // TODO_MA 注释： execution.checkpointing.tolerable-failed-checkpoints = ？
        ...
        // TODO_MA 注释： execution.checkpointing.externalized-checkpoint-retention
        ...
        // TODO_MA 注释： execution.checkpointing.unaligned = false
        configuration.getOptional(ExecutionCheckpointingOptions.ENABLE_UNALIGNED)
                .ifPresent(this::enableUnalignedCheckpoints);

        // TODO_MA 注释： execution.checkpointing.alignment-timeout = 0
        ...
        // TODO_MA 注释： execution.checkpointing.unaligned.forced = true
